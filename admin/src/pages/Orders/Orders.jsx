          ...
          <div className="flex flex-col md:flex-row gap-3">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 border border-amber-200 rounded-xl focus:ring-2 focus:ring-amber-400 focus:border-amber-400 transition-colors duration-200 bg-amber-50/50 text-gray-900"
              />
            </div>
          ...
          <div className="space-y-4">
            {filteredOrders.map((order, index) => (
              ...
              >
                ...
                {expandedOrder === order._id && (
                  <div className="p-5 border-t border-amber-100 animate-slideDown bg-amber-50/30">
